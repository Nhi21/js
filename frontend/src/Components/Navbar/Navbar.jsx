    ...
    return (
        <div className='navbar'>
            ...
            <ul className="nav-menu">
                ...
                <li onClick={() => { setMenu("mens") }}><Link style={{ textDecoration: 'none' }} to='/mens'>Đàn ông</Link>{menu === "mens" ? <hr /> : <></>}</li>
                <li onClick={() => { setMenu("womens") }}><Link style={{ textDecoration: 'none' }} to='/womens'>Phụ nữ</Link>{menu === "womens" ? <hr /> : <></>}</li>
